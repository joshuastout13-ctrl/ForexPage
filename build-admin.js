    ...
    document.getElementById('entityForm').addEventListener('submit', async (e) => {
      ...
      try {
        ...
        if (tab === 'investors') {
          ...
          endpoint = action === 'edit' ? \`/api/admin/commission-shares/\${id}\` : '/api/admin/commission-shares';
          method = action === 'edit' ? 'PATCH' : 'POST';
          body = {
            sourceInvestorId: document.getElementById('field_source_investor_id')?.value,
            accountId: document.getElementById('field_source_account_id')?.value || null,
            recipientUsername: document.getElementById('field_recipient_username')?.value,
            commissionPercent: Number(document.getElementById('field_commission_percent')?.value || 0),
            effectiveStartDate: document.getElementById('field_effective_start_date')?.value,
            effectiveEndDate: document.getElementById('field_effective_end_date')?.value || null,
            status: document.getElementById('field_status')?.value || 'active'
          };
        }
