      ...
      if (tab === 'investors') {
        ...
        if (existingShares.length > 0) {
          rowsHtml = existingShares.map(s => \`
            <tr class="bulk-share-row" data-share-id="\${s.id || ''}">
              ...
              <td style="padding:6px; width:130px;">
                <input type="date" class="bulk-start-date form-control" value="\${s.effective_start_date || new Date().toISOString().split('T')[0]}" style="width:100%; padding:6px; background:var(--bg-input); color:var(--text); border:1px solid var(--border); border-radius:4px;" required />
              </td>
              <td style="padding:6px; width:130px;">
              ...
              <td style="padding:6px; width:90px;">
                <select class="bulk-status form-control" style="width:100%; padding:6px; background:var(--bg-input); color:var(--text); border:1px solid var(--border); border-radius:4px;">
                  <option value="active" \${s.status !== 'cancelled' ? 'selected' : ''}>Active</option>
        ...
        html = \`
          <div style="background:rgba(255,255,255,0.03); border:1px solid var(--border); border-radius:8px; padding:12px; margin-bottom:16px;">
            ...
            <div style="display:flex; justify-content:space-between; font-size:13px; margin-top:8px; background:rgba(0,0,0,0.2); padding:8px 12px; border-radius:6px;">
              <div>Investor Keeps: <strong>\${invSplit}%</strong></div>
              <div>Commission Pool: <strong>\${commissionPool.toFixed(2)}%</strong></div>
              <div>Total Assigned: <strong id="bulkAssignedVal">0%</strong></div>
