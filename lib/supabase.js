...
function normalizeRow(row) {
  ...
  if (row.id) {
    ...
    newRow.investoraccountsaccountid = row.id;
    newRow.depositsdepositid = row.id;
    newRow.withdrawalswithdrawalid = row.id;
    newRow.investormonthlysnapshotssnapshotid = row.id;
    newRow.id = row.id;
  }
