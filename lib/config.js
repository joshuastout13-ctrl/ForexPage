...
export const CONFIG = {
  ...
  myfxbookAccountId: process.env.MYFXBOOK_ACCOUNT_ID || "11915183", // ForEx Investment Tracker account
  ...
  scrapedotdoToken: process.env.SCRAPEDO_TOKEN || "",

  defaultFundYear: Number(process.env.DEFAULT_FUND_YEAR || "2026"),
  sessionSecret: process.env.SESSION_SECRET || "change-this-secret",
  fundAccountingTimezone: "America/Los_Angeles",
