export const CONFIG = {
  ...
  myfxbookUrl:
    process.env.MYFXBOOK_URL ||
    "https://www.myfxbook.com/members/PCSplus/stone-company/11915183",
  defaultFundYear: Number(process.env.DEFAULT_FUND_YEAR || "2026"),
  sessionSecret: process.env.SESSION_SECRET || "change-this-secret",

  tabs: {
    investors: process.env.GOOGLE_INVESTORS_TAB || "Investors",
    accounts: process.env.GOOGLE_ACCOUNTS_TAB || "Investor_Accounts",
    ...
    livePerformance: process.env.GOOGLE_LIVE_PERFORMANCE_TAB || "Live_Performance"
  }
};
